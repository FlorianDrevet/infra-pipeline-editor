...
2. **Enregistrer la dette** pour le reste de la zone non couverte dans `.Codex/test-debt.md` :
...
[ ] Dette de tests enregistrée dans .Codex/test-debt.md si zone non couverte détectée
