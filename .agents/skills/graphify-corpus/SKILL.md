...
| **Transport MCP** | Built-in Codex (SQLite local dans `.codegraph/`) | `python -m graphify.serve graphify-out/graph.json` (stdio) |
...
- `src/Front/src`
- `.Codex/memory/14-frontend-design-system.md`
- `docs`
...
### Depuis un assistant (VS Code Copilot Chat, Codex, etc.)
