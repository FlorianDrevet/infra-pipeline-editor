...
2. **Enregistrer la dette** pour le reste de la zone non couverte dans `.claude/test-debt.md` :
...
[ ] Dette de tests enregistrée dans .claude/test-debt.md si zone non couverte détectée
