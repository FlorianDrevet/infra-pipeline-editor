---
name: new-azure-resource
description: "Use when: adding a new Azure resource type end-to-end (Domain -> Application -> Infrastructure -> Contracts -> API -> Bicep generator -> Frontend -> i18n)."
---
...
1. `.claude/memory/MEMORY.md` lu en entier.
