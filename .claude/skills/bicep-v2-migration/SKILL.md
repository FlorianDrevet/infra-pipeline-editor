---
name: bicep-v2-migration
description: "Use when: migrating an IResourceTypeBicepGenerator from the legacy const-string template + regex pattern to the Builder + IR (Vague 2) pattern, including TDD tests, emitter parity, review cycle, and skill feedback loop."
---
