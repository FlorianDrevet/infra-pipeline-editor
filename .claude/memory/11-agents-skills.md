...
| `graphify-corpus` | Knowledge graph for code, documentation, diagrams, audits, god nodes, community detection, and cross-file architecture | `.claude/skills/graphify-corpus/SKILL.md` |
