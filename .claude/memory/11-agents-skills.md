...
| `codegraph-workflow` | Code exploration via knowledge graph, impact analysis before modifications, post-change validation | `.claude/skills/codegraph-workflow/SKILL.md` |
