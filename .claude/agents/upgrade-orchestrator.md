...
Lire `.claude/memory/MEMORY.md` puis les fichiers thématiques pertinents :
- `.claude/memory/01-solution-overview.md` — stack technique, versions actuelles
- `.claude/memory/10-auth-and-build.md` — build commands, SDK version
...
Après chaque migration réussie, mettre à jour `.claude/memory/` :
...
| Contexte | Skill |
|----------|-------|
| Migration .NET (SDK, TFM, NuGet, EF Core, ASP.NET) | `.claude/skills/dotnet-upgrade/SKILL.md` |
| Migration Angular (CLI, TS, RxJS, npm, Material) | `.claude/skills/angular-upgrade/SKILL.md` |
