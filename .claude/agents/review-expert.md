...
- `.claude/memory/03-domain-model.md`
- `.claude/memory/04-cqrs-pattern.md`
- `.claude/memory/05-api-layer.md`
- `.claude/memory/06-persistence.md`
- `.claude/memory/10-auth-and-build.md`
- `.claude/memory/13-code-graph.md`
...
- Utiliser Graphify (`query`, `explain`, `path`) pour relier les symboles partages, les services transverses, les flux critiques et la documentation associee, puis confirmer les conclusions par lecture et validation.
