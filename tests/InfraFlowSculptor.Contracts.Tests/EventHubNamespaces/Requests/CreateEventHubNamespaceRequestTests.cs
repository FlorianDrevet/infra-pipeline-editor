...
namespace InfraFlowSculptor.Contracts.Tests.EventHubNamespaces.Requests;

public sealed class CreateEventHubNamespaceRequestTests
{
    ...
    {
        // Arrange
        var sut = new CreateEventHubNamespaceRequest
        {
            Name = "evhns-prod",
    ...
    public void Given_NullName_When_Validate_Then_Error()
    {
        ...
        // Assert
        results.HasErrorForMember(nameof(CreateEventHubNamespaceRequest.Name)).Should().BeTrue();
    }
    ...
    public void Given_NullLocation_When_Validate_Then_Error()
    {
        ...
        // Assert
        results.HasErrorForMember(nameof(CreateEventHubNamespaceRequest.Location)).Should().BeTrue();
    }
    ...
    public void Given_EmptyResourceGroupId_When_Validate_Then_Error()
    {
        ...
        // Assert
        results.HasErrorForMember(nameof(CreateEventHubNamespaceRequest.ResourceGroupId)).Should().BeTrue();
    }
}
