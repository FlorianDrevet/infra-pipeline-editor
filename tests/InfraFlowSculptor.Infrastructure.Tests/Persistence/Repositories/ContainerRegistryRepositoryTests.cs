...
public sealed class ContainerRegistryRepositoryTests : IDisposable
{
    private const string DefaultName = "crshared";
    private const string OtherName = "crother";

    private readonly ProjectDbContext _context;
    private readonly ContainerRegistryRepository _sut;

    public ContainerRegistryRepositoryTests()
    {
        _context = InMemoryDbContextFactory.Create();
        _sut = new ContainerRegistryRepository(_context);
    }

    public void Dispose() => _context.Dispose();

    private static ContainerRegistry NewEntity(ResourceGroupId resourceGroupId, string name = DefaultName)
    ...
    public async Task Given_StoredEntity_When_GetByIdAsync_Then_ReturnsEntity_Async()
    {
        ...
        _context.ContainerRegistries.Add(entity);
    ...
    public async Task Given_StoredEntities_When_GetByResourceGroupIdAsync_Then_ReturnsOnlyMatching_Async()
    {
        ...
        _context.ContainerRegistries.AddRange(owned, unrelated);
        await _context.SaveChangesAsync();
