...
public sealed class RemoveTableCommandHandlerTests
{
    ...
    private readonly RemoveTableCommand _command;
    private readonly RemoveTableCommandHandler _sut;

    public RemoveTableCommandHandlerTests()
    {
        ...
        _command = new RemoveTableCommand(
            _storageAccount.Id,
    ...
    [Fact]
    public async Task Given_TableNotFound_When_Handle_Then_ReturnsNotFoundAsync()
    {
        // Arrange
        _storageAccountRepository.GetByIdWithSubResourcesAsync(Arg.Any<AzureResourceId>(), Arg.Any<CancellationToken>())
            .Returns(_storageAccount);
        ...
        _accessService.VerifyWriteAccessAsync(_config.Id, Arg.Any<CancellationToken>())
            .Returns(_config);
        _storageAccountRepository.RemoveTableAsync(_storageAccount.Id, _command.TableId)
            .Returns(false);
