...
public sealed class RemoveBlobContainerCommandHandlerTests
{
    ...
    private readonly RemoveBlobContainerCommand _command;
    private readonly RemoveBlobContainerCommandHandler _sut;

    public RemoveBlobContainerCommandHandlerTests()
    {
        ...
        _command = new RemoveBlobContainerCommand(
            _storageAccount.Id,
    ...
    public async Task Given_ContainerNotFound_When_Handle_Then_ReturnsNotFoundAsync()
    {
        ...
        _accessService.VerifyWriteAccessAsync(_config.Id, Arg.Any<CancellationToken>())
            .Returns(_config);
        _storageAccountRepository.RemoveBlobContainerAsync(_storageAccount.Id, _command.ContainerId)
            .Returns(false);
