...
public sealed class AddEventHubCommandHandlerTests
{
    ...
    private readonly AddEventHubCommand _command;
    private readonly AddEventHubCommandHandler _sut;

    public AddEventHubCommandHandlerTests()
    {
        ...
        _eventHubNamespace = EventHubNamespace.Create(
            ...
            new Location(Location.LocationEnum.FranceCentral));
        _command = new AddEventHubCommand(_eventHubNamespace.Id, EventHubName);
        _sut = new AddEventHubCommandHandler(
    ...
    [Fact]
    public async Task Given_WriteAccessGranted_When_Handle_Then_AddsEventHubAndMapsResultAsync()
    {
        // Arrange
        _eventHubNamespaceRepository.GetByIdAsync(Arg.Any<ValueObject>(), Arg.Any<CancellationToken>())
            .Returns(_eventHubNamespace);
        ...
        _eventHubNamespaceRepository.Received(1).Update(Arg.Is<EventHubNamespace>(eh =>
            eh.EventHubs.Any(e => e.Name == EventHubName)));
