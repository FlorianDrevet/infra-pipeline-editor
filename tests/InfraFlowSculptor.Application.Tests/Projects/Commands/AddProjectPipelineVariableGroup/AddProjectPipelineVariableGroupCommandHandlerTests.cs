...
public sealed class AddProjectPipelineVariableGroupCommandHandlerTests
{
    private const string GroupName = "shared-vars";

    private readonly IProjectAccessService _accessService;
    private readonly IProjectRepository _projectRepository;
    private readonly Project _project;
    private readonly AddProjectPipelineVariableGroupCommand _command;
    private readonly AddProjectPipelineVariableGroupCommandHandler _sut;

    public AddProjectPipelineVariableGroupCommandHandlerTests()
    {
        ...
        _command = new AddProjectPipelineVariableGroupCommand(_project.Id, GroupName);
        _sut = new AddProjectPipelineVariableGroupCommandHandler(_accessService, _projectRepository);
    }
    ...
    [Fact]
    public async Task Given_WriteAccessGranted_When_Handle_Then_AddsGroupAndReturnsResultAsync()
    {
        // Arrange
        _accessService.VerifyWriteAccessAsync(_project.Id, Arg.Any<CancellationToken>())
            .Returns(_project);
