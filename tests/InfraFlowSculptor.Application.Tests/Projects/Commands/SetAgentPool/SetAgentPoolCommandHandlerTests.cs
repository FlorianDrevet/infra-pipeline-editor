...
public sealed class SetAgentPoolCommandHandlerTests
{
    private readonly IProjectRepository _projectRepository;
    private readonly IProjectAccessService _accessService;
    private readonly Project _project;
    private readonly SetAgentPoolCommandHandler _sut;

    public SetAgentPoolCommandHandlerTests()
    {
        ...
        _sut = new SetAgentPoolCommandHandler(_projectRepository, _accessService);
    }

    [Fact]
    public async Task Given_ValidAgentPool_When_Handle_Then_ReturnsSuccessAsync()
    {
        // Arrange
        ...
        _projectRepository.GetByIdWithAllAsync(_project.Id, Arg.Any<CancellationToken>())
            .Returns(_project);
        var command = new SetAgentPoolCommand(_project.Id, "my-pool");
    ...
    [Fact]
    public async Task Given_NullAgentPool_When_Handle_Then_ClearsAndReturnsSuccessAsync()
    {
        // Arrange
        _accessService.VerifyWriteAccessAsync(_project.Id, Arg.Any<CancellationToken>())
            .Returns(_project);
        _projectRepository.GetByIdWithAllAsync(_project.Id, Arg.Any<CancellationToken>())
            .Returns(_project);
        var command = new SetAgentPoolCommand(_project.Id, null);
