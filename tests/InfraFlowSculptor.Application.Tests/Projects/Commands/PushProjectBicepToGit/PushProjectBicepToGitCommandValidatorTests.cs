...
public sealed class PushProjectBicepToGitCommandValidatorTests
{
    private const string ValidBranchName = "feature/bicep";
    private const string ValidCommitMessage = "Push Bicep files";
    private const string ProjectIdProperty = "ProjectId.Value";
    private const string BranchNameProperty = nameof(PushProjectBicepToGitCommand.BranchName);
    private const string CommitMessageProperty = nameof(PushProjectBicepToGitCommand.CommitMessage);

    private readonly PushProjectBicepToGitCommandValidator _sut = new();
    ...
    private static PushProjectBicepToGitCommand CreateCommand(
        ProjectId? projectId = null,
        string branchName = ValidBranchName,
        string commitMessage = ValidCommitMessage)
    {
        return new PushProjectBicepToGitCommand(
