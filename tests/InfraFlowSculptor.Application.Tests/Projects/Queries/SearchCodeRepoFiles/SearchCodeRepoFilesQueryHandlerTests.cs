...
public sealed class SearchCodeRepoFilesQueryHandlerTests
{
    ...
    private readonly SearchCodeRepoFilesQuery _query;
    private readonly SearchCodeRepoFilesQueryHandler _sut;

    public SearchCodeRepoFilesQueryHandlerTests()
    {
        ...
        _query = new SearchCodeRepoFilesQuery(_project.Id, "main", "*.yml", _config.Id);
        ...
        var helper = new GitRepoQueryHelper(
            ...
            gitProviderFactory,
            targetResolver);
        _sut = new SearchCodeRepoFilesQueryHandler(helper);
    }
