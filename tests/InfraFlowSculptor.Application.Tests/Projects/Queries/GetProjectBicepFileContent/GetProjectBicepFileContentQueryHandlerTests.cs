...
namespace InfraFlowSculptor.Application.Tests.Projects.Queries.GetProjectBicepFileContent;

public sealed class GetProjectBicepFileContentQueryHandlerTests
{
    private const string FilePath = "main.bicep";
    private const string FileContent = "resource storageAccount 'Microsoft.Storage/storageAccounts@2023-01-01'";

    private readonly IProjectAccessService _accessService;
    private readonly IBlobService _blobService;
    private readonly Project _project;
    private readonly Guid _projectGuid;
    private readonly GetProjectBicepFileContentQueryHandler _sut;

    public GetProjectBicepFileContentQueryHandlerTests()
    {
        ...
        _sut = new GetProjectBicepFileContentQueryHandler(_accessService, _blobService);
    }
    ...
    {
        // Arrange
        var blobPrefix = $"bicep/project/{_projectGuid}/";
        var timestamp = "20260101120000";
        var blobPath = $"bicep/project/{_projectGuid}/{timestamp}/{FilePath}";
        ...
        _blobService.DownloadContentAsync(blobPath)
            .Returns(FileContent);
        var query = new GetProjectBicepFileContentQuery(_projectGuid, FilePath);
