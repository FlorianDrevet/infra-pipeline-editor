...
This project is indexed by GitNexus as **infra-pipeline-editor** (22650 symbols, 92458 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
