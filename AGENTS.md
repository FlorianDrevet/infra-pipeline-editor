...
This project is indexed by GitNexus as **infra-pipeline-editor** (18519 symbols, 70468 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
