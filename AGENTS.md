...
This project is indexed by GitNexus as **infra-pipeline-editor** (26398 symbols, 145783 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
