...
This project is indexed by GitNexus as **infra-pipeline-editor** (24405 symbols, 102949 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
