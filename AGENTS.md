...
This project is indexed by GitNexus as **infra-pipeline-editor** (13493 symbols, 61271 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
