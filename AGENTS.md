...
This project is indexed by GitNexus as **infra-pipeline-editor** (25133 symbols, 138821 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
