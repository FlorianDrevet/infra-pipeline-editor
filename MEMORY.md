...
| `.github/memory/08-frontend.md` | Angular 21 app architecture, i18n, auth, shared UX patterns |
...
- **`@dream`** runs when: >= 24h since last dream AND >= 5 sessions, and `@dev` acquires the exclusive Dream lock (rules in `dream-state.md`)
