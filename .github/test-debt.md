...
| 11 | `InfraFlowSculptor.Application` | Imports/PreviewIacImport analyzer + query | The ARM import preview analyzer and `PreviewIacImportQueryHandler` are currently exercised only through `InfraFlowSculptor.Mcp.Tests`; there is still no dedicated Application test project or slice-local Application test coverage for this feature. | P1 | 2026-04-28 | | |
