...
public sealed record CheckResourceNameAvailabilityResponse(
    string ResourceType,
    string RawName,
    bool Supported,
    IReadOnlyList<EnvironmentNameAvailabilityResponseItem> Environments);
...
public sealed record EnvironmentNameAvailabilityResponseItem(
