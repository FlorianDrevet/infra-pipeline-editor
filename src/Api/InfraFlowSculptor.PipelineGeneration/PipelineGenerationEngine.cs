...
public sealed class PipelineGenerationEngine
{
    ...
    private static string GenerateConfigVarsFile(string configName, IReadOnlyCollection<EnvironmentDefinition> environments)
    {
        var sb = new StringBuilder();
    ...
    private static string BuildOverrideParameters(
        IReadOnlyCollection<GenerationCore.Models.PipelineVariableGroupDefinition> variableGroups)
    {
