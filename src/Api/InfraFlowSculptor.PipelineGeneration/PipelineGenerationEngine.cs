...
public sealed class PipelineGenerationEngine
{
    ...
    public PipelineGenerationResult Generate(GenerationRequest request, string configName, bool isMonoRepo = false)
    {
        ...
        {
            ["ci.pipeline.yml"] = GenerateConfigCiPipeline(configName, isMonoRepo),
            ["pr.pipeline.yml"] = GenerateConfigPrPipeline(configName, isMonoRepo),
    ...
    private static string GenerateConfigPrPipeline(string configName, bool isMonoRepo)
    {
    ...
    private static string GenerateConfigCiPipeline(string configName, bool isMonoRepo)
    {
        var sharedTemplatePath = isMonoRepo
