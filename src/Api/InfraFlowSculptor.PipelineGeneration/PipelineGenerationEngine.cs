...
public sealed class PipelineGenerationEngine
{
        ...
        IReadOnlyList<EnvironmentDefinition> environments)
    {
        ...
        var files = new Dictionary<string, string>
        {
            ...
            ["pipelines/pr.pipeline.yml"] = GenerateSharedPrTemplate(configNames),
            ["jobs/deploy.job.yml"] = GenerateSharedDeployJob(configNames, environmentNames),
    ...
    private static string GenerateSharedPrTemplate(IReadOnlyList<string> configNames)
    {
        var sb = new StringBuilder();
        ...
        sb.AppendLine("        displayName: Validate");
        sb.AppendLine("        pool:");
        sb.AppendLine("          name: 'Azure Pipelines'");
