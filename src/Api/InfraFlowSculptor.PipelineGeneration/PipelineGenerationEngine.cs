...
public sealed class PipelineGenerationEngine
{
    ...
    public PipelineGenerationResult Generate(GenerationRequest request, string configName, bool isMonoRepo = false)
    {
        ...
        {
            ["ci.pipeline.yml"] = GenerateConfigCiPipeline(configName, request.AgentPoolName, isMonoRepo),
            ["pr.pipeline.yml"] = GenerateConfigPrPipeline(configName, request.AgentPoolName, isMonoRepo),
            ["release.pipeline.yml"] = GenerateConfigReleasePipeline(request, configName, request.AgentPoolName, isMonoRepo),
        };
    ...
    private static string GenerateConfigReleasePipeline(GenerationRequest request, string configName, string? agentPoolName, bool isMonoRepo = false)
    {
        var sb = new StringBuilder();
