...
public sealed class PipelineGenerationEngine
{
    ...
    private static string GenerateSharedDeployStep()
    {
        ...
        sb.AppendLine("        az bicep build-params --file $resolvedParametersFile --outfile $compiledParametersFile");
        sb.AppendLine("        if ($LASTEXITCODE -ne 0) {");
        sb.AppendLine("          throw \"Failed to compile parameters file: $resolvedParametersFile\"");
        sb.AppendLine("        }");
        sb.AppendLine("      }");
        sb.AppendLine();
