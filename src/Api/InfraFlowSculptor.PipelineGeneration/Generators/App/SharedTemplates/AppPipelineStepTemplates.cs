...
internal static class AppPipelineStepTemplates
{
    ...
    internal const string DockerBuildxPushStep = """
        ...
        steps:
          - powershell: |
              ...
              $builderName = 'ifs-builder'
              $builderExists = docker buildx ls --format "{{.Name}}" |
                Where-Object { $_ -eq $builderName } |
                Select-Object -First 1
              if ($LASTEXITCODE -ne 0) {
                throw 'Docker buildx ls failed.'
              }
    ...
    internal const string SonarAnalysisStep = """
        # Run SonarQube/SonarCloud static analysis — Auto-generated by InfraFlowSculptor
          ...
          - task: SonarQubePrepare@6
            ...
            inputs:
              ...
              ${{ if ne(parameters.sonarOrganization, '') }}:
                cliOrganization: ${{ parameters.sonarOrganization }}
    ...
    internal const string LintingStep = """
        # Run linting command — Auto-generated by InfraFlowSculptor
        ...
        steps:
          - powershell: |
              ...
              Write-Host "Run linting: $command"
              Invoke-Expression $command
              if ($LASTEXITCODE -ne 0) {
    ...
    internal const string LicenseCheckStep = """
        # License compliance check — Auto-generated by InfraFlowSculptor
    ...
    internal const string NotificationStep = """
