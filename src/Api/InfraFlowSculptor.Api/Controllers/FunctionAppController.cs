...
{
    /// <summary>Registers the Function App endpoints on the route builder.</summary>
    public static IEndpointRouteBuilder MapFunctionAppEndpoints(this IEndpointRouteBuilder app)
    {
        var group = app.MapGroup("/function-app")
