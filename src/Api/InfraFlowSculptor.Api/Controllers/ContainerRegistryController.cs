...
public static class ContainerRegistryController
{
    ...
    public static IEndpointRouteBuilder MapContainerRegistryEndpoints(this IEndpointRouteBuilder app)
    {
        var group = app.MapGroup("/container-registry")
        ...
        var acrAccessGroup = app.MapGroup("/azure-resources/{resourceId:guid}/check-acr-pull-access")
            .WithTags("Container Registries");
