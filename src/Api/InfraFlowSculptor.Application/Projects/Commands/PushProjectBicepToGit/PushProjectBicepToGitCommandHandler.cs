...
public sealed class PushProjectBicepToGitCommandHandler(
    ...
    : IRequestHandler<PushProjectBicepToGitCommand, ErrorOr<PushBicepToGitResult>>
{
    /// <inheritdoc />
        ...
        Guid projectId, CancellationToken cancellationToken)
    {
        ...
        if (allBlobs.Count == 0)
            return Error.NotFound(
                "PushProjectBicepToGit.NoFiles",
                $"No generated Bicep files found for project '{projectId}'.");
