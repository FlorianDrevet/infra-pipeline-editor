...
/// <summary>
/// Groups the bootstrap pipeline, variable-group, environment, and service connection definitions assembled for a project.
/// </summary>
...
/// <param name="ServiceConnections">The service connections that must exist in Azure DevOps.</param>
