...
/// <summary>Validates the <see cref="PushProjectGeneratedArtifactsToGitCommand"/> before it is handled.</summary>
public sealed class PushProjectGeneratedArtifactsToGitCommandValidator
    : AbstractValidator<PushProjectGeneratedArtifactsToGitCommand>
{
    /// <summary>Initializes the validator.</summary>
    public PushProjectGeneratedArtifactsToGitCommandValidator()
    {
