...
/// <param name="RepositoryId">The expected project repository id.</param>
/// <param name="BranchName">The target branch to create or update.</param>
/// <param name="CommitMessage">The Git commit message.</param>
public sealed record RepoPushTarget(ProjectRepositoryId RepositoryId, string BranchName, string CommitMessage);
