...
{
    /// <summary>Domain errors for the App Service Plan aggregate.</summary>
    public static class AppServicePlan
    {
        private const string NotFoundCode = "AppServicePlan.NotFound";
        ...
        public static Error NotFoundError(AzureResourceId id) => Error.NotFound(
            code: NotFoundCode,
            description: $"An App Service Plan with the given id {id} does not exist.",
