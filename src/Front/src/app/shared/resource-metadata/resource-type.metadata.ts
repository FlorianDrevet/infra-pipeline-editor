 ...
 */
export const RESOURCE_TYPE_OPTIONS = Object.entries(ResourceTypeEnum).map(([label, value]) => ({
  label,
  value,
}));
 ...
 */
export const RESOURCE_TYPE_ABBREVIATIONS: Readonly<Record<string, string>> = {
  KeyVault: 'kv',
  RedisCache: 'redis',
  StorageAccount: 'stg',
  AppServicePlan: 'asp',
 ...
 */
export const PARENT_CHILD_RESOURCE_TYPES: Readonly<Record<string, string[]>> = {
 ...
 */
export const CHILD_RESOURCE_TYPES = new Set<string>(Object.values(PARENT_CHILD_RESOURCE_TYPES).flat());